...
export const photos = [
  ...
  { src: '/images/menu_churros.jpg', alt: 'Churros con cajeta — crispy golden churros with Mexican caramel' },
]
...
export const favorites = [
  ...
  { name: 'Churros con Cajeta', mentions: 9, img: '/images/menu_churros.jpg' },
]
